...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceChatArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string chatUid,
            global::Instill.AgentPublicServiceChatBody request);
        partial void PrepareAgentPublicServiceChatRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            string chatUid,
            global::Instill.AgentPublicServiceChatBody request);
        partial void ProcessAgentPublicServiceChatResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceChatResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Instill.ChatResponse> AgentPublicServiceChatAsync(
            string namespaceId,
            string chatUid,
            global::Instill.AgentPublicServiceChatBody request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceChatArguments(
            ...
            PrepareAgentPublicServiceChatRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceChatResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceChatResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.ChatResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.ChatResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
