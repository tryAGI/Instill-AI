...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceCreateMessageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string chatUid,
            global::Instill.CreateMessageBody request);
        partial void PrepareAgentPublicServiceCreateMessageRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            string chatUid,
            global::Instill.CreateMessageBody request);
        partial void ProcessAgentPublicServiceCreateMessageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceCreateMessageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.CreateMessageResponse> AgentPublicServiceCreateMessageAsync(
            string namespaceId,
            string chatUid,
            global::Instill.CreateMessageBody request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceCreateMessageArguments(
            ...
            PrepareAgentPublicServiceCreateMessageRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceCreateMessageResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceCreateMessageResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            else
            {
                ...
                return
                    await global::Instill.CreateMessageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AgentPublicServiceCreateMessageAsync(
                namespaceId: namespaceId,
                chatUid: chatUid,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
