...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceListChatsArguments(
            ...
            ref bool? ifAll,
            ref string? chatUid);
        partial void PrepareAgentPublicServiceListChatsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? ifAll,
            string? chatUid);
        partial void ProcessAgentPublicServiceListChatsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceListChatsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.ListChatsResponse> AgentPublicServiceListChatsAsync(
            string namespaceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceListChatsArguments(
            ...
            __pathBuilder 
                ...
                .AddOptionalParameter("chatUid", chatUid) 
                ; 
            ...
            PrepareAgentPublicServiceListChatsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceListChatsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceListChatsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.ListChatsResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.ListChatsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
