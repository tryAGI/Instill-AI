...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceUpdateChatArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string chatUid,
            global::Instill.UpdateChatBody request);
        partial void PrepareAgentPublicServiceUpdateChatRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            string chatUid,
            global::Instill.UpdateChatBody request);
        partial void ProcessAgentPublicServiceUpdateChatResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceUpdateChatResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.UpdateChatResponse> AgentPublicServiceUpdateChatAsync(
            string namespaceId,
            string chatUid,
            global::Instill.UpdateChatBody request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceUpdateChatArguments(
            ...
            PrepareAgentPublicServiceUpdateChatRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceUpdateChatResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceUpdateChatResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.UpdateChatResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.UpdateChatResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AgentPublicServiceUpdateChatAsync(
                namespaceId: namespaceId,
                chatUid: chatUid,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
