...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceUpdateMessageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string chatUid,
            ref string messageUid,
            global::Instill.UpdateMessageBody request);
        partial void PrepareAgentPublicServiceUpdateMessageRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string messageUid,
            global::Instill.UpdateMessageBody request);
        partial void ProcessAgentPublicServiceUpdateMessageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceUpdateMessageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Instill.UpdateMessageResponse> AgentPublicServiceUpdateMessageAsync(
            string namespaceId,
            string chatUid,
            string messageUid,
            global::Instill.UpdateMessageBody request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceUpdateMessageArguments(
            ...
            PrepareAgentPublicServiceUpdateMessageRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceUpdateMessageResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceUpdateMessageResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.UpdateMessageResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.UpdateMessageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AgentPublicServiceUpdateMessageAsync(
                namespaceId: namespaceId,
                chatUid: chatUid,
                messageUid: messageUid,
                request: __request,
