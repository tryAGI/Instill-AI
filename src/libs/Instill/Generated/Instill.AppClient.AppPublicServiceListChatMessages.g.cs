...
namespace Instill
{
    ...
    {
        partial void PrepareAppPublicServiceListChatMessagesArguments(
            ...
            ref bool? ifAll);
        partial void PrepareAppPublicServiceListChatMessagesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? pageToken,
            bool? ifAll);
        partial void ProcessAppPublicServiceListChatMessagesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAppPublicServiceListChatMessagesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List chat messages<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Instill.ListChatMessagesResponse> AppPublicServiceListChatMessagesAsync(
            string namespaceId,
            string chatUid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAppPublicServiceListChatMessagesArguments(
            ...
            PrepareAppPublicServiceListChatMessagesRequest(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAppPublicServiceListChatMessagesResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.ListChatMessagesResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.ListChatMessagesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
