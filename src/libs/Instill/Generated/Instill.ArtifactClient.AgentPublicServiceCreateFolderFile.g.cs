...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceCreateFolderFileArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string folderUid,
            global::Instill.File request);
        partial void PrepareAgentPublicServiceCreateFolderFileRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            string folderUid,
            global::Instill.File request);
        partial void ProcessAgentPublicServiceCreateFolderFileResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceCreateFolderFileResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.CreateFolderFileResponse> AgentPublicServiceCreateFolderFileAsync(
            string namespaceId,
            string folderUid,
            global::Instill.File request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceCreateFolderFileArguments(
            ...
            var __pathBuilder = new global::Instill.PathBuilder(
                path: $"/v1alpha/namespaces/{namespaceId}/folders/{folderUid}/files",
            ...
            PrepareAgentPublicServiceCreateFolderFileRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceCreateFolderFileResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceCreateFolderFileResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Instill.CreateFolderFileResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Instill.CreateFolderFileResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AgentPublicServiceCreateFolderFileAsync(
                namespaceId: namespaceId,
                folderUid: folderUid,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
