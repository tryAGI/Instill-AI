...
namespace Instill
{
    public partial class ArtifactClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_ArtifactPublicServiceCreateKnowledgeBaseServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_ArtifactPublicServiceCreateKnowledgeBaseSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_ArtifactPublicServiceCreateKnowledgeBaseSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_ArtifactPublicServiceCreateKnowledgeBaseSecurityRequirement0,
            };
        partial void PrepareArtifactPublicServiceCreateKnowledgeBaseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string parent,
            global::Instill.KnowledgeBase request);
        partial void PrepareArtifactPublicServiceCreateKnowledgeBaseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string parent,
            global::Instill.KnowledgeBase request);
        partial void ProcessArtifactPublicServiceCreateKnowledgeBaseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessArtifactPublicServiceCreateKnowledgeBaseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.CreateKnowledgeBaseResponse> ArtifactPublicServiceCreateKnowledgeBaseAsync(
            string parent,
        ...
        {
            var __response = await ArtifactPublicServiceCreateKnowledgeBaseAsResponseAsync(
                parent: parent,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_ALPHA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.CreateKnowledgeBaseResponse>> ArtifactPublicServiceCreateKnowledgeBaseAsResponseAsync(
            string parent,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareArtifactPublicServiceCreateKnowledgeBaseArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ArtifactPublicServiceCreateKnowledgeBaseSecurityRequirements,
                operationName: "ArtifactPublicServiceCreateKnowledgeBaseAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                path: $"/v1alpha/{parent}/knowledge-bases",
                                baseUri: ResolveBaseUri(
                                servers: s_ArtifactPublicServiceCreateKnowledgeBaseServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareArtifactPublicServiceCreateKnowledgeBaseRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ArtifactPublicServiceCreateKnowledgeBase",
                                methodName: "ArtifactPublicServiceCreateKnowledgeBaseAsync",
                                pathTemplate: "$\"/v1alpha/{parent}/knowledge-bases\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessArtifactPublicServiceCreateKnowledgeBaseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessArtifactPublicServiceCreateKnowledgeBaseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.CreateKnowledgeBaseResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.CreateKnowledgeBaseResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.CreateKnowledgeBaseResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ArtifactPublicServiceCreateKnowledgeBaseAsync(
                parent: parent,
                request: __request,
                requestOptions: requestOptions,
