...
namespace Instill
{
    public partial class ArtifactClient
    {
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_ArtifactPublicServiceGetObjectDownloadURLSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_ArtifactPublicServiceGetObjectDownloadURLSecurityRequirement0,
            };
        partial void PrepareArtifactPublicServiceGetObjectDownloadURLArguments(
        ...
        partial void ProcessArtifactPublicServiceGetObjectDownloadURLResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.GetObjectDownloadURLResponse> ArtifactPublicServiceGetObjectDownloadURLAsync(
            string name,
        ...
        {
            var __response = await ArtifactPublicServiceGetObjectDownloadURLAsResponseAsync(
                name: name,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_ALPHA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.GetObjectDownloadURLResponse>> ArtifactPublicServiceGetObjectDownloadURLAsResponseAsync(
            string name,
            int? urlExpireDays = default,
            string? downloadFilename = default,
            string? format = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareArtifactPublicServiceGetObjectDownloadURLArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ArtifactPublicServiceGetObjectDownloadURLSecurityRequirements,
                operationName: "ArtifactPublicServiceGetObjectDownloadURLAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ArtifactPublicServiceGetObjectDownloadURL",
                                methodName: "ArtifactPublicServiceGetObjectDownloadURLAsync",
                                pathTemplate: "$\"/v1alpha/{name}/download-url\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessArtifactPublicServiceGetObjectDownloadURLResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessArtifactPublicServiceGetObjectDownloadURLResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.GetObjectDownloadURLResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.GetObjectDownloadURLResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.GetObjectDownloadURLResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
