...
namespace Instill
{
    public partial class ArtifactClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_ArtifactPublicServiceListChunksServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_ArtifactPublicServiceListChunksSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_ArtifactPublicServiceListChunksSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_ArtifactPublicServiceListChunksSecurityRequirement0,
            };
        partial void PrepareArtifactPublicServiceListChunksArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string parent,
            ref int? pageSize,
            ref string? pageToken,
            ref string? filter);
        partial void PrepareArtifactPublicServiceListChunksRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? pageToken,
            string? filter);
        partial void ProcessArtifactPublicServiceListChunksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessArtifactPublicServiceListChunksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.ListChunksResponse> ArtifactPublicServiceListChunksAsync(
            string parent,
        ...
        {
            var __response = await ArtifactPublicServiceListChunksAsResponseAsync(
                parent: parent,
                pageSize: pageSize,
                pageToken: pageToken,
                filter: filter,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_ALPHA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.ListChunksResponse>> ArtifactPublicServiceListChunksAsResponseAsync(
            string parent,
            int? pageSize = default,
            string? pageToken = default,
            string? filter = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareArtifactPublicServiceListChunksArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ArtifactPublicServiceListChunksSecurityRequirements,
                operationName: "ArtifactPublicServiceListChunksAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                ...
                                servers: s_ArtifactPublicServiceListChunksServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareArtifactPublicServiceListChunksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ArtifactPublicServiceListChunks",
                                methodName: "ArtifactPublicServiceListChunksAsync",
                                pathTemplate: "$\"/v1alpha/{parent}/chunks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessArtifactPublicServiceListChunksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessArtifactPublicServiceListChunksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.ListChunksResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.ListChunksResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.ListChunksResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
