...
namespace Instill
{
    public partial class ArtifactClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_ArtifactPublicServiceReprocessFileServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_ArtifactPublicServiceReprocessFileSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_ArtifactPublicServiceReprocessFileSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_ArtifactPublicServiceReprocessFileSecurityRequirement0,
            };
        ...
        partial void ProcessArtifactPublicServiceReprocessFileResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ArtifactPublicServiceReprocessFileAsResponseAsync(
                name: name,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_ALPHA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.ReprocessFileResponse>> ArtifactPublicServiceReprocessFileAsResponseAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareArtifactPublicServiceReprocessFileArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ArtifactPublicServiceReprocessFileSecurityRequirements,
                operationName: "ArtifactPublicServiceReprocessFileAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                path: $"/v1alpha/{name}/reprocess",
                                baseUri: ResolveBaseUri(
                                servers: s_ArtifactPublicServiceReprocessFileServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareArtifactPublicServiceReprocessFileRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ArtifactPublicServiceReprocessFile",
                                methodName: "ArtifactPublicServiceReprocessFileAsync",
                                pathTemplate: "$\"/v1alpha/{name}/reprocess\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessArtifactPublicServiceReprocessFileResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessArtifactPublicServiceReprocessFileResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.ReprocessFileResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.ReprocessFileResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.ReprocessFileResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ArtifactPublicServiceReprocessFileAsync(
                name: name,
                request: __request,
                requestOptions: requestOptions,
