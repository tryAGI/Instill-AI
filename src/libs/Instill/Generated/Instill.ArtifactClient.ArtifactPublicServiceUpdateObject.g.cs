...
namespace Instill
{
    public partial class ArtifactClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_ArtifactPublicServiceUpdateObjectServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_ArtifactPublicServiceUpdateObjectSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_ArtifactPublicServiceUpdateObjectSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_ArtifactPublicServiceUpdateObjectSecurityRequirement0,
            };
        partial void PrepareArtifactPublicServiceUpdateObjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string objectName,
            global::Instill.UpdateObjectBody request);
        partial void PrepareArtifactPublicServiceUpdateObjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string objectName,
            global::Instill.UpdateObjectBody request);
        partial void ProcessArtifactPublicServiceUpdateObjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessArtifactPublicServiceUpdateObjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.UpdateObjectResponse> ArtifactPublicServiceUpdateObjectAsync(
            string objectName,
        ...
        {
            var __response = await ArtifactPublicServiceUpdateObjectAsResponseAsync(
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_ALPHA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.UpdateObjectResponse>> ArtifactPublicServiceUpdateObjectAsResponseAsync(
            string objectName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareArtifactPublicServiceUpdateObjectArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ArtifactPublicServiceUpdateObjectSecurityRequirements,
                operationName: "ArtifactPublicServiceUpdateObjectAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                path: $"/v1alpha/{objectName}",
                                baseUri: ResolveBaseUri(
                                servers: s_ArtifactPublicServiceUpdateObjectServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareArtifactPublicServiceUpdateObjectRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ArtifactPublicServiceUpdateObject",
                                methodName: "ArtifactPublicServiceUpdateObjectAsync",
                                pathTemplate: "$\"/v1alpha/{objectName}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessArtifactPublicServiceUpdateObjectResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessArtifactPublicServiceUpdateObjectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.UpdateObjectResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.UpdateObjectResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.UpdateObjectResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ArtifactPublicServiceUpdateObjectAsync(
                objectName: objectName,
                request: __request,
                requestOptions: requestOptions,
