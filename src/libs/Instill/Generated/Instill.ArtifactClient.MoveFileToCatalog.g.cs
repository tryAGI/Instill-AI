...
namespace Instill
{
    ...
    {
        partial void PrepareMoveFileToCatalogArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string catalogId,
            global::Instill.MoveFileToCatalogBody request);
        partial void PrepareMoveFileToCatalogRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            string catalogId,
            global::Instill.MoveFileToCatalogBody request);
        partial void ProcessMoveFileToCatalogResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMoveFileToCatalogResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.MoveFileToCatalogResponse> MoveFileToCatalogAsync(
            string namespaceId,
            string catalogId,
            global::Instill.MoveFileToCatalogBody request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareMoveFileToCatalogArguments(
            ...
            var __pathBuilder = new global::Instill.PathBuilder(
                path: $"/v1alpha/namespaces/{namespaceId}/catalogs/{catalogId}/files:move",
            ...
            PrepareMoveFileToCatalogRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessMoveFileToCatalogResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessMoveFileToCatalogResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.MoveFileToCatalogResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.MoveFileToCatalogResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Instill.MoveFileToCatalogResponse> MoveFileToCatalogAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Instill.MoveFileToCatalogBody
            {
                FileUid = fileUid,
                ToCatalogId = toCatalogId,
            };

            return await MoveFileToCatalogAsync(
                namespaceId: namespaceId,
                catalogId: catalogId,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
