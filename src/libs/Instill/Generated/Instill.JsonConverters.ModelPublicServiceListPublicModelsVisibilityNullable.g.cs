...
{
    /// <inheritdoc />
    public sealed class ModelPublicServiceListPublicModelsVisibilityNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Instill.ModelPublicServiceListPublicModelsVisibility?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Instill.ModelPublicServiceListPublicModelsVisibilityExtensions.ToValueString(value.Value));
            }
        }
    }
}
