...
namespace Instill
{
    public partial class ModelClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_ModelPublicServiceListModelVersionsServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_ModelPublicServiceListModelVersionsSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_ModelPublicServiceListModelVersionsSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_ModelPublicServiceListModelVersionsSecurityRequirement0,
            };
        partial void PrepareModelPublicServiceListModelVersionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string parent,
            ref int? pageSize,
            ref int? page);
        partial void PrepareModelPublicServiceListModelVersionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string parent,
            int? pageSize,
            int? page);
        partial void ProcessModelPublicServiceListModelVersionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessModelPublicServiceListModelVersionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.ListModelVersionsResponse> ModelPublicServiceListModelVersionsAsync(
            string parent,
        ...
        {
            var __response = await ModelPublicServiceListModelVersionsAsResponseAsync(
                parent: parent,
                pageSize: pageSize,
                page: page,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_ALPHA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.ListModelVersionsResponse>> ModelPublicServiceListModelVersionsAsResponseAsync(
            string parent,
            int? pageSize = default,
            int? page = default,
            global::Instill.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareModelPublicServiceListModelVersionsArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ModelPublicServiceListModelVersionsSecurityRequirements,
                operationName: "ModelPublicServiceListModelVersionsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                ...
                                servers: s_ModelPublicServiceListModelVersionsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareModelPublicServiceListModelVersionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModelPublicServiceListModelVersions",
                                methodName: "ModelPublicServiceListModelVersionsAsync",
                                pathTemplate: "$\"/v1alpha/{parent}/versions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessModelPublicServiceListModelVersionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessModelPublicServiceListModelVersionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.ListModelVersionsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.ListModelVersionsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.ListModelVersionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
