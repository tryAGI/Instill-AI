...
namespace Instill
{
    public partial class ModelClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_ModelPublicServiceTriggerModelServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_ModelPublicServiceTriggerModelSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_ModelPublicServiceTriggerModelSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_ModelPublicServiceTriggerModelSecurityRequirement0,
            };
        partial void PrepareModelPublicServiceTriggerModelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name1,
            ref string? instillRequesterUid,
            global::Instill.TriggerModelBody request);
        partial void PrepareModelPublicServiceTriggerModelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name1,
            string? instillRequesterUid,
            global::Instill.TriggerModelBody request);
        partial void ProcessModelPublicServiceTriggerModelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessModelPublicServiceTriggerModelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.TriggerModelResponse> ModelPublicServiceTriggerModelAsync(
            string name1,
        ...
        {
            var __response = await ModelPublicServiceTriggerModelAsResponseAsync(
                name1: name1,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_ALPHA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.TriggerModelResponse>> ModelPublicServiceTriggerModelAsResponseAsync(
            string name1,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareModelPublicServiceTriggerModelArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ModelPublicServiceTriggerModelSecurityRequirements,
                operationName: "ModelPublicServiceTriggerModelAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                path: $"/v1alpha/{name1}/trigger",
                                baseUri: ResolveBaseUri(
                                servers: s_ModelPublicServiceTriggerModelServers,
            ...
            if (instillRequesterUid != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareModelPublicServiceTriggerModelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModelPublicServiceTriggerModel",
                                methodName: "ModelPublicServiceTriggerModelAsync",
                                pathTemplate: "$\"/v1alpha/{name1}/trigger\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessModelPublicServiceTriggerModelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessModelPublicServiceTriggerModelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.TriggerModelResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.TriggerModelResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.TriggerModelResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Instill.TriggerModelResponse> ModelPublicServiceTriggerModelAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Instill.TriggerModelBody
            {
                TaskInputs = taskInputs,
            };

            return await ModelPublicServiceTriggerModelAsync(
                name1: name1,
                instillRequesterUid: instillRequesterUid,
                request: __request,
                requestOptions: requestOptions,
