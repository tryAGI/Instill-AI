...
namespace Instill
{
    ...
    public sealed partial class AgentPublicServiceChatWithTableBuilderAgentResponse
    {
        ...
        public global::Instill.ChatWithTableBuilderAgentResponse? Result { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentPublicServiceChatWithTableBuilderAgentResponse" /> class.
        /// </summary>
        /// <param name="result">
        /// ChatWithTableBuilderAgentResponse contains the response from the table builder agent.
        /// </param>
...
#endif
        public AgentPublicServiceChatWithTableBuilderAgentResponse(
            global::Instill.ChatWithTableBuilderAgentResponse? result,
