...
{
    /// <summary>
    /// TriggerPipelineReleaseRequest represents a request to trigger a<br/>
    ...
    public sealed partial class TriggerAsyncPipelineReleaseBody
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TriggerAsyncPipelineReleaseBody" /> class.
        /// </summary>
        /// <param name="inputs">
        /// Pipeline input parameters, it will be deprecated soon.
        /// </param>
...
#endif
        public TriggerAsyncPipelineReleaseBody(
