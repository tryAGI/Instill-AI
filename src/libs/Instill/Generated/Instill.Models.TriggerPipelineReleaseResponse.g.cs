...
{
    /// <summary>
    /// TriggerPipelineReleaseResponse contains the pipeline execution<br/>
    ...
    public sealed partial class TriggerPipelineReleaseResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TriggerPipelineReleaseResponse" /> class.
        /// </summary>
        /// <param name="outputs">
        /// Model inference outputs.<br/>
        /// Included only in responses
...
#endif
        public TriggerPipelineReleaseResponse(
