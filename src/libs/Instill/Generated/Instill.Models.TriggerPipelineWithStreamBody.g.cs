...
{
    /// <summary>
    /// TriggerPipelineWithStreamRequest represents a request to trigger a<br/>
    ...
    public sealed partial class TriggerPipelineWithStreamBody
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TriggerPipelineWithStreamBody" /> class.
        /// </summary>
        /// <param name="inputs">
        /// Pipeline input parameters, it will be deprecated soon.
        /// </param>
...
#endif
        public TriggerPipelineWithStreamBody(
