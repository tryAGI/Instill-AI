...
namespace Instill
{
    ...
    {
        partial void PrepareInviteOrganizationMembersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string organizationId,
            global::Instill.InviteOrganizationMembersBody request);
        partial void PrepareInviteOrganizationMembersRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string organizationId,
            global::Instill.InviteOrganizationMembersBody request);
        partial void ProcessInviteOrganizationMembersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInviteOrganizationMembersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<string> InviteOrganizationMembersAsync(
            string organizationId,
            global::Instill.InviteOrganizationMembersBody request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInviteOrganizationMembersArguments(
                httpClient: HttpClient,
                organizationId: ref organizationId,
                request: request);

            var __pathBuilder = new global::Instill.PathBuilder(
                path: $"/v1beta/organizations/{organizationId}/invite-members",
            ...
            PrepareInviteOrganizationMembersRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessInviteOrganizationMembersResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessInviteOrganizationMembersResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> InviteOrganizationMembersAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Instill.InviteOrganizationMembersBody
            {
                Emails = emails,
            };

            return await InviteOrganizationMembersAsync(
                organizationId: organizationId,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
