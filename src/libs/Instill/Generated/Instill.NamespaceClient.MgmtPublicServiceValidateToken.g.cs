...
namespace Instill
{
    public partial class NamespaceClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_MgmtPublicServiceValidateTokenServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_MgmtPublicServiceValidateTokenSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_MgmtPublicServiceValidateTokenSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_MgmtPublicServiceValidateTokenSecurityRequirement0,
            };
        partial void PrepareMgmtPublicServiceValidateTokenArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareMgmtPublicServiceValidateTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessMgmtPublicServiceValidateTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMgmtPublicServiceValidateTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.ValidateTokenResponse> MgmtPublicServiceValidateTokenAsync(
            global::Instill.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await MgmtPublicServiceValidateTokenAsResponseAsync(
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_BETA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.ValidateTokenResponse>> MgmtPublicServiceValidateTokenAsResponseAsync(
            global::Instill.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMgmtPublicServiceValidateTokenArguments(
                httpClient: HttpClient);


            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_MgmtPublicServiceValidateTokenSecurityRequirements,
                operationName: "MgmtPublicServiceValidateTokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                path: "/v1beta/validate-token",
                                baseUri: ResolveBaseUri(
                                servers: s_MgmtPublicServiceValidateTokenServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMgmtPublicServiceValidateTokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MgmtPublicServiceValidateToken",
                                methodName: "MgmtPublicServiceValidateTokenAsync",
                                pathTemplate: "\"/v1beta/validate-token\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMgmtPublicServiceValidateTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMgmtPublicServiceValidateTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.ValidateTokenResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.ValidateTokenResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.ValidateTokenResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
