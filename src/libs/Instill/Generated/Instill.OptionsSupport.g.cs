...
namespace Instill
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Instill.AutoSDKRetryOptions Retry { get; set; } = new global::Instill.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Instill.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Instill.IAutoSDKHook>();
        ...
        public global::Instill.AutoSDKClientOptions AddHook(
            global::Instill.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Instill.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Instill.AutoSDKClientOptions UseAuthorizationProvider(
            global::Instill.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Instill.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Instill.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Instill.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Instill.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Instill.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Instill.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Instill.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Instill.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Instill.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Instill.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Instill.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Instill.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Instill.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Instill.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Instill.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Instill.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Instill.AutoSDKClientOptions clientOptions,
            global::Instill.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Instill.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Instill.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Instill.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Instill.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Instill.IAutoSDKHook, global::Instill.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Instill.AutoSDKHookContext context)
        {
