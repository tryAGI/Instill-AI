...
namespace Instill
{
    public partial class PipelineClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_PipelinePublicServiceListPublicPipelinesServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_PipelinePublicServiceListPublicPipelinesSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_PipelinePublicServiceListPublicPipelinesSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_PipelinePublicServiceListPublicPipelinesSecurityRequirement0,
            };
        partial void PreparePipelinePublicServiceListPublicPipelinesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? pageSize,
            ref string? pageToken,
            ref global::Instill.PipelinePublicServiceListPublicPipelinesView? view,
            ref string? filter,
            ref bool? showDeleted,
            ref global::Instill.PipelinePublicServiceListPublicPipelinesVisibility? visibility,
            ref string? orderBy);
        partial void PreparePipelinePublicServiceListPublicPipelinesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? pageSize,
            string? pageToken,
            global::Instill.PipelinePublicServiceListPublicPipelinesView? view,
            string? filter,
            bool? showDeleted,
            global::Instill.PipelinePublicServiceListPublicPipelinesVisibility? visibility,
            string? orderBy);
        partial void ProcessPipelinePublicServiceListPublicPipelinesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPipelinePublicServiceListPublicPipelinesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.ListPublicPipelinesResponse> PipelinePublicServiceListPublicPipelinesAsync(
        ...
        {
            var __response = await PipelinePublicServiceListPublicPipelinesAsResponseAsync(
                pageSize: pageSize,
                pageToken: pageToken,
                view: view,
                filter: filter,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_BETA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.ListPublicPipelinesResponse>> PipelinePublicServiceListPublicPipelinesAsResponseAsync(
            int? pageSize = default,
            string? pageToken = default,
            global::Instill.PipelinePublicServiceListPublicPipelinesView? view = default,
            string? filter = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePipelinePublicServiceListPublicPipelinesArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PipelinePublicServiceListPublicPipelinesSecurityRequirements,
                operationName: "PipelinePublicServiceListPublicPipelinesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                ...
                                servers: s_PipelinePublicServiceListPublicPipelinesServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePipelinePublicServiceListPublicPipelinesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinePublicServiceListPublicPipelines",
                                methodName: "PipelinePublicServiceListPublicPipelinesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPipelinePublicServiceListPublicPipelinesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPipelinePublicServiceListPublicPipelinesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.ListPublicPipelinesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.ListPublicPipelinesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.ListPublicPipelinesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
