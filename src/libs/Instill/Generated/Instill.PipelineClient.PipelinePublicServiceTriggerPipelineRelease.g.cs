...
namespace Instill
{
    public partial class PipelineClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_PipelinePublicServiceTriggerPipelineReleaseServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_PipelinePublicServiceTriggerPipelineReleaseSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_PipelinePublicServiceTriggerPipelineReleaseSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_PipelinePublicServiceTriggerPipelineReleaseSecurityRequirement0,
            };
        partial void PreparePipelinePublicServiceTriggerPipelineReleaseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name1,
            ref string? instillRequesterUid,
            global::Instill.TriggerPipelineReleaseBody request);
        partial void PreparePipelinePublicServiceTriggerPipelineReleaseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name1,
            string? instillRequesterUid,
            global::Instill.TriggerPipelineReleaseBody request);
        partial void ProcessPipelinePublicServiceTriggerPipelineReleaseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPipelinePublicServiceTriggerPipelineReleaseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await PipelinePublicServiceTriggerPipelineReleaseAsResponseAsync(
                name1: name1,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_BETA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.TriggerPipelineReleaseResponse>> PipelinePublicServiceTriggerPipelineReleaseAsResponseAsync(
            string name1,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePipelinePublicServiceTriggerPipelineReleaseArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PipelinePublicServiceTriggerPipelineReleaseSecurityRequirements,
                operationName: "PipelinePublicServiceTriggerPipelineReleaseAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                path: $"/v1beta/{name1}/trigger",
                                baseUri: ResolveBaseUri(
                                servers: s_PipelinePublicServiceTriggerPipelineReleaseServers,
            ...
            if (instillRequesterUid != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePipelinePublicServiceTriggerPipelineReleaseRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinePublicServiceTriggerPipelineRelease",
                                methodName: "PipelinePublicServiceTriggerPipelineReleaseAsync",
                                pathTemplate: "$\"/v1beta/{name1}/trigger\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPipelinePublicServiceTriggerPipelineReleaseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPipelinePublicServiceTriggerPipelineReleaseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.TriggerPipelineReleaseResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.TriggerPipelineReleaseResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.TriggerPipelineReleaseResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Instill.TriggerPipelineReleaseResponse> PipelinePublicServiceTriggerPipelineReleaseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Instill.TriggerPipelineReleaseBody
            {
                Inputs = inputs,
                Data = data,
            };

            return await PipelinePublicServiceTriggerPipelineReleaseAsync(
                name1: name1,
                instillRequesterUid: instillRequesterUid,
                request: __request,
                requestOptions: requestOptions,
