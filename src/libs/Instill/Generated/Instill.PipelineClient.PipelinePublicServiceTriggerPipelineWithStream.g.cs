...
namespace Instill
{
    public partial class PipelineClient
    {
        ...
        private static readonly global::Instill.AutoSDKServer[] s_PipelinePublicServiceTriggerPipelineWithStreamServers = new global::Instill.AutoSDKServer[]
        ...
        private static readonly global::Instill.EndPointSecurityRequirement s_PipelinePublicServiceTriggerPipelineWithStreamSecurityRequirement0 =
        ...
        private static readonly global::Instill.EndPointSecurityRequirement[] s_PipelinePublicServiceTriggerPipelineWithStreamSecurityRequirements =
            new global::Instill.EndPointSecurityRequirement[]
            {                s_PipelinePublicServiceTriggerPipelineWithStreamSecurityRequirement0,
            };
        partial void PreparePipelinePublicServiceTriggerPipelineWithStreamArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name,
            ref string? instillRequesterUid,
            global::Instill.TriggerPipelineWithStreamBody request);
        partial void PreparePipelinePublicServiceTriggerPipelineWithStreamRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name,
            string? instillRequesterUid,
            global::Instill.TriggerPipelineWithStreamBody request);
        partial void ProcessPipelinePublicServiceTriggerPipelineWithStreamResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPipelinePublicServiceTriggerPipelineWithStreamResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.PipelinePublicServiceTriggerPipelineWithStreamResponse> PipelinePublicServiceTriggerPipelineWithStreamAsync(
            string name,
        ...
        {
            var __response = await PipelinePublicServiceTriggerPipelineWithStreamAsResponseAsync(
                name: name,
        ...
        [global::System.Diagnostics.CodeAnalysis.Experimental(diagnosticId: "INSTILL_BETA_001")]
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.AutoSDKHttpResponse<global::Instill.PipelinePublicServiceTriggerPipelineWithStreamResponse>> PipelinePublicServiceTriggerPipelineWithStreamAsResponseAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePipelinePublicServiceTriggerPipelineWithStreamArguments(
            ...
            var __authorizations = global::Instill.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PipelinePublicServiceTriggerPipelineWithStreamSecurityRequirements,
                operationName: "PipelinePublicServiceTriggerPipelineWithStreamAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Instill.PathBuilder(
                                path: $"/v1beta/{name}/trigger-stream",
                                baseUri: ResolveBaseUri(
                                servers: s_PipelinePublicServiceTriggerPipelineWithStreamServers,
            ...
            if (instillRequesterUid != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePipelinePublicServiceTriggerPipelineWithStreamRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Instill.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Instill.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinePublicServiceTriggerPipelineWithStream",
                                methodName: "PipelinePublicServiceTriggerPipelineWithStreamAsync",
                                pathTemplate: "$\"/v1beta/{name}/trigger-stream\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPipelinePublicServiceTriggerPipelineWithStreamResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Instill.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPipelinePublicServiceTriggerPipelineWithStreamResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Instill.PipelinePublicServiceTriggerPipelineWithStreamResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Instill.AutoSDKHttpResponse<global::Instill.PipelinePublicServiceTriggerPipelineWithStreamResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Instill.PipelinePublicServiceTriggerPipelineWithStreamResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Instill.PipelinePublicServiceTriggerPipelineWithStreamResponse> PipelinePublicServiceTriggerPipelineWithStreamAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Instill.TriggerPipelineWithStreamBody
            {
                Inputs = inputs,
                Data = data,
            };

            return await PipelinePublicServiceTriggerPipelineWithStreamAsync(
                name: name,
                instillRequesterUid: instillRequesterUid,
                request: __request,
                requestOptions: requestOptions,
