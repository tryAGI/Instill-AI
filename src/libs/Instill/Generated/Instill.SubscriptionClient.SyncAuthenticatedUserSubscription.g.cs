...
namespace Instill
{
    ...
    {
        partial void PrepareSyncAuthenticatedUserSubscriptionArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareSyncAuthenticatedUserSubscriptionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessSyncAuthenticatedUserSubscriptionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSyncAuthenticatedUserSubscriptionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<string> SyncAuthenticatedUserSubscriptionAsync(
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSyncAuthenticatedUserSubscriptionArguments(
                httpClient: HttpClient);

            var __pathBuilder = new global::Instill.PathBuilder(
                path: "/v1beta/user/subscription/sync",
            ...
            PrepareSyncAuthenticatedUserSubscriptionRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessSyncAuthenticatedUserSubscriptionResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessSyncAuthenticatedUserSubscriptionResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
