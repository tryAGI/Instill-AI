...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceCreateTableFromTemplateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            global::Instill.CreateTableFromTemplateBody request);
        partial void PrepareAgentPublicServiceCreateTableFromTemplateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            global::Instill.CreateTableFromTemplateBody request);
        partial void ProcessAgentPublicServiceCreateTableFromTemplateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceCreateTableFromTemplateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceCreateTableFromTemplateArguments(
                httpClient: HttpClient,
                namespaceId: ref namespaceId,
                request: request);

            var __pathBuilder = new global::Instill.PathBuilder(
                path: $"/v1alpha/namespaces/{namespaceId}/tables/from-template",
            ...
            PrepareAgentPublicServiceCreateTableFromTemplateRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceCreateTableFromTemplateResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceCreateTableFromTemplateResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Instill.CreateTableFromTemplateResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Instill.CreateTableFromTemplateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
