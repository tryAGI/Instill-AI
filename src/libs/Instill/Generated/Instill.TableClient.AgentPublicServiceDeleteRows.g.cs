...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceDeleteRowsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string tableUid,
            global::System.Collections.Generic.IList<string> rowUids);
        partial void PrepareAgentPublicServiceDeleteRowsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            string tableUid,
            global::System.Collections.Generic.IList<string> rowUids);
        partial void ProcessAgentPublicServiceDeleteRowsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceDeleteRowsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<string> AgentPublicServiceDeleteRowsAsync(
            string namespaceId,
            string tableUid,
            global::System.Collections.Generic.IList<string> rowUids,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceDeleteRowsArguments(
            ...
            __pathBuilder 
                .AddRequiredParameter("rowUids", rowUids, delimiter: ",", explode: true) 
                ; 
            ...
            PrepareAgentPublicServiceDeleteRowsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceDeleteRowsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceDeleteRowsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
