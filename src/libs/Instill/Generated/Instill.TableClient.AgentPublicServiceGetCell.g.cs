...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceGetCellArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string tableUid,
            ref string rowUid,
            ref string cellUid);
        partial void PrepareAgentPublicServiceGetCellRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string rowUid,
            string cellUid);
        partial void ProcessAgentPublicServiceGetCellResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceGetCellResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.GetCellResponse> AgentPublicServiceGetCellAsync(
            string namespaceId,
            string tableUid,
            string rowUid,
            string cellUid,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceGetCellArguments(
            ...
            PrepareAgentPublicServiceGetCellRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceGetCellResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceGetCellResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.GetCellResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.GetCellResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
