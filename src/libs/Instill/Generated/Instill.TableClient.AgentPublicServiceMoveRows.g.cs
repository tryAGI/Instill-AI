...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceMoveRowsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string tableUid,
            global::Instill.MoveRowsBody request);
        partial void PrepareAgentPublicServiceMoveRowsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            string tableUid,
            global::Instill.MoveRowsBody request);
        partial void ProcessAgentPublicServiceMoveRowsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceMoveRowsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<string> AgentPublicServiceMoveRowsAsync(
            string namespaceId,
            string tableUid,
            global::Instill.MoveRowsBody request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceMoveRowsArguments(
            ...
            PrepareAgentPublicServiceMoveRowsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceMoveRowsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceMoveRowsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AgentPublicServiceMoveRowsAsync(
                namespaceId: namespaceId,
                tableUid: tableUid,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
