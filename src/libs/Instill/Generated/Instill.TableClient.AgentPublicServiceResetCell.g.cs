...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceResetCellArguments(
            ...
            ref string cellUid,
            object request);
        partial void PrepareAgentPublicServiceResetCellRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string cellUid,
            object request);
        partial void ProcessAgentPublicServiceResetCellResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceResetCellResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.ResetCellResponse> AgentPublicServiceResetCellAsync(
            string namespaceId,
            string tableUid,
            string rowUid,
            string cellUid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceResetCellArguments(
            ...
            var __pathBuilder = new global::Instill.PathBuilder(
                path: $"/v1alpha/namespaces/{namespaceId}/tables/{tableUid}/rows/{rowUid}/cells/{cellUid}/reset",
            ...
            PrepareAgentPublicServiceResetCellRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceResetCellResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceResetCellResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Instill.ResetCellResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Instill.ResetCellResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AgentPublicServiceResetCellAsync(
                namespaceId: namespaceId,
                tableUid: tableUid,
                rowUid: rowUid,
                cellUid: cellUid,
