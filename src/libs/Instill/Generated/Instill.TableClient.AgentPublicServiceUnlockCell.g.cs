...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceUnlockCellArguments(
            ...
            ref string cellUid,
            object request);
        partial void PrepareAgentPublicServiceUnlockCellRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string cellUid,
            object request);
        partial void ProcessAgentPublicServiceUnlockCellResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceUnlockCellResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.UnlockCellResponse> AgentPublicServiceUnlockCellAsync(
            string namespaceId,
            string tableUid,
            string rowUid,
            string cellUid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceUnlockCellArguments(
            ...
            PrepareAgentPublicServiceUnlockCellRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceUnlockCellResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceUnlockCellResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.UnlockCellResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.UnlockCellResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AgentPublicServiceUnlockCellAsync(
                namespaceId: namespaceId,
                tableUid: tableUid,
                rowUid: rowUid,
                cellUid: cellUid,
