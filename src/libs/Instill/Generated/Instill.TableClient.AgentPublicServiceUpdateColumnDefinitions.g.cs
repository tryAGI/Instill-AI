...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceUpdateColumnDefinitionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string tableUid,
            global::System.Collections.Generic.Dictionary<string, global::Instill.ColumnDefinition> request);
        partial void PrepareAgentPublicServiceUpdateColumnDefinitionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            string tableUid,
            global::System.Collections.Generic.Dictionary<string, global::Instill.ColumnDefinition> request);
        partial void ProcessAgentPublicServiceUpdateColumnDefinitionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceUpdateColumnDefinitionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.UpdateColumnDefinitionsResponse> AgentPublicServiceUpdateColumnDefinitionsAsync(
            string namespaceId,
            string tableUid,
            global::System.Collections.Generic.Dictionary<string, global::Instill.ColumnDefinition> request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceUpdateColumnDefinitionsArguments(
            ...
            var __pathBuilder = new global::Instill.PathBuilder(
                path: $"/v1alpha/namespaces/{namespaceId}/tables/{tableUid}/column-definitions",
            ...
            PrepareAgentPublicServiceUpdateColumnDefinitionsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceUpdateColumnDefinitionsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceUpdateColumnDefinitionsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.UpdateColumnDefinitionsResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.UpdateColumnDefinitionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Instill.UpdateColumnDefinitionsResponse> AgentPublicServiceUpdateColumnDefinitionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::System.Collections.Generic.Dictionary<string, global::Instill.ColumnDefinition>
            {
            };

            return await AgentPublicServiceUpdateColumnDefinitionsAsync(
                namespaceId: namespaceId,
                tableUid: tableUid,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
