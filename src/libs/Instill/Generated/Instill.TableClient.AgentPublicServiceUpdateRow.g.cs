...
namespace Instill
{
    ...
    {
        partial void PrepareAgentPublicServiceUpdateRowArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string tableUid,
            ref string rowUid,
            global::Instill.UpdateRowBody request);
        partial void PrepareAgentPublicServiceUpdateRowRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string rowUid,
            global::Instill.UpdateRowBody request);
        partial void ProcessAgentPublicServiceUpdateRowResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentPublicServiceUpdateRowResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
...
#endif
        public async global::System.Threading.Tasks.Task<global::Instill.UpdateRowResponse> AgentPublicServiceUpdateRowAsync(
            string namespaceId,
            string tableUid,
            string rowUid,
            global::Instill.UpdateRowBody request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentPublicServiceUpdateRowArguments(
            ...
            PrepareAgentPublicServiceUpdateRowRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAgentPublicServiceUpdateRowResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAgentPublicServiceUpdateRowResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Instill.UpdateRowResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                return
                    await global::Instill.UpdateRowResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AgentPublicServiceUpdateRowAsync(
                namespaceId: namespaceId,
                tableUid: tableUid,
                rowUid: rowUid,
                request: __request,
