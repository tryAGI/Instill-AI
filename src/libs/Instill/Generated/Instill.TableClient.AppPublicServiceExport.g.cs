...
namespace Instill
{
    ...
    {
        partial void PrepareAppPublicServiceExportArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string namespaceId,
            ref string tableUid,
            ref string type);
        partial void PrepareAppPublicServiceExportRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string namespaceId,
            string tableUid,
            string type);
        partial void ProcessAppPublicServiceExportResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAppPublicServiceExportResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Instill.ExportResponse> AppPublicServiceExportAsync(
            string namespaceId,
            string tableUid,
            string type,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAppPublicServiceExportArguments(
            ...
            PrepareAppPublicServiceExportRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessAppPublicServiceExportResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessAppPublicServiceExportResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
